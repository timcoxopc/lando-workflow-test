...
/**
 * @file
 * Contains \Drupal\paypal_donations\PayPalDonatePermissions.
 */

namespace Drupal\paypal_donations;
 ...
 */
class PayPalDonatePermissions implements ContainerInjectionInterface {
